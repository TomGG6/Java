...
public class Billboard implements IBillboard {
    ...
    public static void main(String[] args) throws NotBoundException, RemoteException, BadLocationException {
        ...
        BillboardGUI ui = new BillboardGUI(manager, iBillboard, billboard.adverts, billboard.displayInterval);
    }
